...
// PG_GYRO_CONFIG
    ...
    { "gyro_stage2_lma_depth",      VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 11 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_pt1lma_depth) },
    { "gyro_stage2_lma_weight",     VAR_UINT8 | MASTER_VALUE, .config.minmax = { 0, 100 }, PG_GYRO_CONFIG, offsetof(gyroConfig_t, gyro_pt1lma_weight) },
#endif
